...
#define XPAR_AXI_GPIO_DATATRIGGER_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_DATATRIGGER_DEVICE_ID 0
#define XPAR_AXI_GPIO_DATATRIGGER_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_DATATRIGGER_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_DDS_CONFIG */
#define XPAR_AXI_GPIO_DDS_CONFIG_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_DDS_CONFIG_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_DDS_CONFIG_DEVICE_ID 1
#define XPAR_AXI_GPIO_DDS_CONFIG_INTERRUPT_PRESENT 0
...
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_DATATRIGGER_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_DDS_CONFIG */
