...
HD_PWD='D:/Work/Hobby_proj/spectrum_analyzer/spectrum_analyzer.runs/design_1_data_on_trigger_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_data_on_trigger_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_data_on_trigger_0_0.tcl
