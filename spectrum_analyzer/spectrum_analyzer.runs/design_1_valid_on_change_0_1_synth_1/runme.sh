...
HD_PWD='D:/Work/Hobby_proj/spectrum_analyzer/spectrum_analyzer.runs/design_1_valid_on_change_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_valid_on_change_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_valid_on_change_0_1.tcl
