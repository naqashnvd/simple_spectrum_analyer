...
--               D:/Work/Hobby_proj/spectrum_analyzer/spectrum_analyzer.srcs/sources_1/bd/design_1/ip/design_1_valid_on_change_0_1/design_1_valid_on_change_0_1_sim_netlist.vhdl
...
entity design_1_valid_on_change_0_1_valid_on_change is
  port (
    m_axi_config_tdata : out STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  attribute ORIG_REF_NAME of design_1_valid_on_change_0_1_valid_on_change : entity is "valid_on_change";
end design_1_valid_on_change_0_1_valid_on_change;

architecture STRUCTURE of design_1_valid_on_change_0_1_valid_on_change is
  signal \^m_axi_config_tdata\ : STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  signal \reg_idata[23]_i_1_n_0\ : STD_LOGIC;
  signal \reg_idata[23]_i_2_n_0\ : STD_LOGIC;
...
begin
  m_axi_config_tdata(23 downto 0) <= \^m_axi_config_tdata\(23 downto 0);
...
\reg_idata[23]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \^m_axi_config_tvalid\,
      I1 => \reg_idata0_carry__0_n_0\,
      O => \reg_idata[23]_i_1_n_0\
    );
\reg_idata[23]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => rstn,
      O => \reg_idata[23]_i_2_n_0\
    );
\reg_idata_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => \reg_idata[23]_i_1_n_0\,
      CLR => \reg_idata[23]_i_2_n_0\,
      D => iData(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_valid_on_change_0_1 is
  port (
    clk : in STD_LOGIC;
    rstn : in STD_LOGIC;
    iData : in STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_valid_on_change_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_valid_on_change_0_1 : entity is "design_1_valid_on_change_0_1,valid_on_change,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_valid_on_change_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_valid_on_change_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_valid_on_change_0_1 : entity is "valid_on_change,Vivado 2019.2";
end design_1_valid_on_change_0_1;

architecture STRUCTURE of design_1_valid_on_change_0_1 is
...
begin
inst: entity work.design_1_valid_on_change_0_1_valid_on_change
     port map (
      clk => clk,
